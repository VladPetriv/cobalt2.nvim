...
Group.new("BufferInactive", colors.blue, nil, nil)
Group.new("BufferInactiveIndex", colors.blue, nil, nil)
Group.new("BufferInactiveMod", colors.blue, nil, nil)
Group.new("BufferInactiveSign", colors.blue, nil, nil)
Group.new("BufferInactiveTarget", colors.dark_pink, nil, nil)
